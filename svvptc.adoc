...
page-fault or those accessing new memory regions. Although a memory-management
fence could facilitate immediate visibility of these PTE updates to implicit
references, when Svvptc is implemented, a memory-management fence is not
required. While this approach might lead to an occasional gratuitous page-fault,
